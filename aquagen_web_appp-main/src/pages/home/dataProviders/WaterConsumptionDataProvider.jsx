...
const WaterConsumptionDataContext = createContext({});

const WaterConsumptionScreenDataProvider = ({ categoryId, children }) => {
    ...
    if (homeStore.homeScreenData[categoryId]) {
        return (
            <WaterConsumptionDataContext.Provider value={value}>
                {children}
            </WaterConsumptionDataContext.Provider>
        );
    } else {
        return (
            <Expanded
...
export { WaterConsumptionDataContext, WaterConsumptionScreenDataProvider };
