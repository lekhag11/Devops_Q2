...
const BuildConsumptionReport = () => {
    ...
    const reportsDownloadClick = () => {
        ReportController.downloadReport(
            isIrFrIncluded
                ? StandardCategoryReportType.SOURCE_CATEGORY
    ...
    return (
        <Box sx={{ marginLeft: '16px', marginRight: '16px' }}>
            <Box>
                ...
                <If
                    condition={
                        selectedReportType === ReportType.MONTHLY && false
                    }
                >
                    <Box marginTop={2}>
                        <Typography
                    ...
                    <Box marginTop={0.5}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    name='includeInitialFinal'
                                    onChange={(event) =>
                                        setIsIrFrIncluded(event.target.checked)
                                    }
                                    checked={isIrFrIncluded}
                                />
                            }
                            label='Include Initial Reading and Final Reading'
                            sx={commonStyles.typography}
                        />
                    </Box>
                </If>
...
export default BuildConsumptionReport;
